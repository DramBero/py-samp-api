...
FUNC_SAMP_SENDCMD                    = 0x65C60   # R1 0x65c60  R2 0x65d30 R3 0x69110 R4 0x698C0
FUNC_SAMP_SENDSAY                    = 0x57F0    # R1 0x57f0  R2 0x57e0 R3 0x5820 R4 0x5A00
FUNC_SAMP_ADDTOCHATWND               = 0x64010   # R1 0x64010 R2 0x640E0 R3 0x67460 R4 0x67BA0
...
def set_offsets():
    ...
    if samp_version == 1:                    # 0.3.7-R2
        ...
        FUNC_SAMP_SENDCMD 					 = 0x65d30
        FUNC_SAMP_SENDSAY 					 = 0x57e0
